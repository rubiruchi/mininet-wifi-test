...
# ---------------------------------------------------------
    WSERVER_SECTOR_UPDATE_REQUEST_TYPE = 23
    WSERVER_SECTOR_UPDATE_RESPONSE_TYPE = 24
    WSERVER_MAXSECTOR_UPDATE_REQUEST_TYPE = 25
    WSERVER_MAXSECTOR_UPDATE_RESPONSE_TYPE = 26
    WSERVER_MAINDB_UPDATE_REQUEST_TYPE = 27
    WSERVER_MAINDB_UPDATE_RESPONSE_TYPE = 28
    WSERVER_SIDEDB_UPDATE_REQUEST_TYPE = 29
    WSERVER_SIDEDB_UPDATE_RESPONSE_TYPE = 30
# -------------------------------------------------------
    WUPDATE_SUCCESS = 0
...
# -----------------------------------
    ...
    def update_sector(cls, sector):
        ...
        :type link: WmediumdSPECPROBLink
        """
        WmediumdServer.update_sector(sector)

    @classmethod
    def update_maxsector(cls, maxsector):
        # type: (WmediumdSPECPROBLink) -> None
        """
        Update the error probability matrix of a connection at wmediumd
        :param link The link to update
        ...
        :type link: WmediumdSPECPROBLink
        """
        WmediumdServer.update_maxsector(maxsector)

    @classmethod
    def update_maindB(cls, db):
        # type: (WmediumdSPECPROBLink) -> None
        """
        Update the error probability matrix of a connection at wmediumd
        :param link The link to update
        ...
        :type link: WmediumdSPECPROBLink
        """
        WmediumdServer.update_maindB(db)

    @classmethod
    def update_sidedB(cls, db):
        # type: (WmediumdSPECPROBLink) -> None
        """
        Update the error probability matrix of a connection at wmediumd
        :param link The link to update
        ...
        :type link: WmediumdSPECPROBLink
        """
        WmediumdServer.update_sidedB(db)
...
#------------------------
class WmediumdSector(object):
    def __init__(self, staintf, sta_sector):
        self.staintf = staintf
        self.sta_sector = sta_sector
class WmediumdMaxSector(object):
    def __init__(self, staintf, sta_maxsector):
        self.staintf = staintf
        self.sta_maxsector = sta_maxsector
class WmediumddMaindB(object):
    def __init__(self, staintf, sta_maindB):
        self.staintf = staintf
        self.sta_maindB = sta_maindB
class WmediumdSidedB(object):
    def __init__(self, staintf, sta_sidedB):
        self.staintf = staintf
        self.sta_sidedB = sta_sidedB
#------------------------
...
# -------------------------------
    __sector_update_request_fmt = \
        __base_struct_fmt + __mac_struct_fmt + 'i'
    __sector_update_response_fmt = \
        __base_struct_fmt + __sector_update_request_fmt + 'B'
    __sector_update_request_struct = \
        struct.Struct('!' + __sector_update_request_fmt)
    __sector_update_response_struct = \
        struct.Struct('!' + __sector_update_response_fmt)

    __maxsector_update_request_fmt = \
        __base_struct_fmt + __mac_struct_fmt + 'i'
    __maxsector_update_response_fmt = \
        __base_struct_fmt + __maxsector_update_request_fmt + 'B'
    __maxsector_update_request_struct = \
        struct.Struct('!' + __maxsector_update_request_fmt)
    __maxsector_update_response_struct = \
        struct.Struct('!' + __maxsector_update_response_fmt)

    __maindb_update_request_fmt = \
        __base_struct_fmt + __mac_struct_fmt + 'i'
    __maindb_update_response_fmt = \
        __base_struct_fmt + __maindb_update_request_fmt + 'B'
    __maindb_update_request_struct = \
        struct.Struct('!' + __maindb_update_request_fmt)
    __maindb_update_response_struct = \
        struct.Struct('!' + __maindb_update_response_fmt)

    __sidedb_update_request_fmt = \
        __base_struct_fmt + __mac_struct_fmt + 'i'
    __sidedb_update_response_fmt = \
        __base_struct_fmt + __sidedb_update_request_fmt + 'B'
    __sidedb_update_request_struct = \
        struct.Struct('!' + __sidedb_update_request_fmt)
    __sidedb_update_response_struct = \
        struct.Struct('!' + __sidedb_update_response_fmt)
...
# -----------------------------------
    ...
    def update_sector(cls, gain):
        ...
        :type gain: WmediumdGain
        """
        ret = WmediumdServer.send_sector_update(gain)
        if ret != WmediumdCst.WUPDATE_SUCCESS:
            raise WmediumdException("Received error code from wmediumd: "
                                    "code %d" % ret)
    @classmethod
    def update_maxsector(cls, gain):
        # type: (WmediumdGain) -> None
        """
        Update the Antenna Gain of a connection at wmediumd
        :param gain The gain to update
        ...
        :type gain: WmediumdGain
        """
        ret = WmediumdServer.send_maxsector_update(gain)
        if ret != WmediumdCst.WUPDATE_SUCCESS:
            raise WmediumdException("Received error code from wmediumd: "
                                    "code %d" % ret)

    @classmethod
    def update_maindB(cls, gain):
        # type: (WmediumdGain) -> None
        """
        Update the Antenna Gain of a connection at wmediumd
        :param gain The gain to update
        ...
        :type gain: WmediumdGain
        """
        ret = WmediumdServer.send_maindb_update(gain)
        if ret != WmediumdCst.WUPDATE_SUCCESS:
            raise WmediumdException("Received error code from wmediumd: "
                                    "code %d" % ret)

    @classmethod
    def update_sidedB(cls, gain):
        # type: (WmediumdGain) -> None
        """
        Update the Antenna Gain of a connection at wmediumd
        :param gain The gain to update
        ...
        :type gain: WmediumdGain
        """
        ret = WmediumdServer.send_sidedb_update(gain)
        if ret != WmediumdCst.WUPDATE_SUCCESS:
            raise WmediumdException("Received error code from wmediumd: "
                                    "code %d" % ret)
 # ---------------------------------
...
# -------------------
    @classmethod
    def send_sector_update(cls, sector):
        # type: (WmediumdGain) -> int
        """
        Send an update to the wmediumd server
        :param gain: The WmediumdGain to update
        :return: A WUPDATE_* constant
        """
        sector_ = sector.sta_sector
        debug("%s Updating Antenna Gain of %s to %d\n" % (
            WmediumdCst.LOG_PREFIX, sector.staintf.get_mac(),
            sector_))
        cls.sock.send(cls.__create_sector_update_request(sector))
        return cls.__parse_response(
            WmediumdCst.WSERVER_SECTOR_UPDATE_RESPONSE_TYPE,
            cls.__sector_update_response_struct)[-1]

    @classmethod
    def send_maxsector_update(cls, maxsector):
        # type: (WmediumdGain) -> int
        """
        Send an update to the wmediumd server
        :param gain: The WmediumdGain to update
        :return: A WUPDATE_* constant
        """
        maxsector_ = maxsector.sta_maxsector
        debug("%s Updating Antenna Gain of %s to %d\n" % (
            WmediumdCst.LOG_PREFIX, maxsector.staintf.get_mac(),
            maxsector_))
        cls.sock.send(cls.__create_maxsector_update_request(maxsector))
        return cls.__parse_response(
            WmediumdCst.WSERVER_MAXSECTOR_UPDATE_RESPONSE_TYPE,
            cls.__maxsector_update_response_struct)[-1]

    @classmethod
    def send_maindB_update(cls, main):
        # type: (WmediumdGain) -> int
        """
        Send an update to the wmediumd server
        :param gain: The WmediumdGain to update
        :return: A WUPDATE_* constant
        """
        maindB_ = main.sta_maindB
        debug("%s Updating Antenna Gain of %s to %d\n" % (
            WmediumdCst.LOG_PREFIX, main.staintf.get_mac(),
            maindB_))
        cls.sock.send(cls.__create_maindb_update_request(main))
        return cls.__parse_response(
            WmediumdCst.WSERVER_MAINDB_UPDATE_RESPONSE_TYPE,
            cls.__maindb_update_response_struct)[-1]

    @classmethod
    def send_sidedB_update(cls, side):
        # type: (WmediumdGain) -> int
        """
        Send an update to the wmediumd server
        :param gain: The WmediumdGain to update
        :return: A WUPDATE_* constant
        """
        sidedB_ = side.sta_sidedB
        debug("%s Updating Antenna Gain of %s to %d\n" % (
            WmediumdCst.LOG_PREFIX, side.staintf.get_mac(),
            sidedB_))
        cls.sock.send(cls.__create_sidedb_update_request(side))
        return cls.__parse_response(
            WmediumdCst.WSERVER_SIDEDB_UPDATE_RESPONSE_TYPE,
            cls.__sidedb_update_response_struct)[-1]
...
# -------------------------------------------
    ...
    @classmethod
    def __create_sector_update_request(cls, sector):
        "antenna gain update request"
        # type: (WmediumdGain) -> str
        msgtype = WmediumdCst.WSERVER_SECTOR_UPDATE_REQUEST_TYPE
        if py_version_info < (3, 0):
            mac = sector.staintf.get_mac().replace(':', '').decode('hex')
        else:
            mac = bytes.fromhex((sector.staintf.get_mac().replace(':', '')))
        sector_ = sector.sta_gain
        return cls.__sector_update_request_struct.pack(msgtype, mac, sector_)

    @classmethod
    def __create_maxsector_update_request(cls, sector):
        "antenna gain update request"
        # type: (WmediumdGain) -> str
        msgtype = WmediumdCst.WSERVER_MAXSECTOR_UPDATE_REQUEST_TYPE
        if py_version_info < (3, 0):
            mac = sector.staintf.get_mac().replace(':', '').decode('hex')
        else:
            mac = bytes.fromhex((sector.staintf.get_mac().replace(':', '')))
        maxsector_ = sector.sta_maxsector
        return cls.__maxsector_update_request_struct.pack(msgtype, mac, maxsector_)

    @classmethod
    def __create_maindb_update_request(cls, gain):
        "antenna gain update request"
        # type: (WmediumdGain) -> str
        msgtype = WmediumdCst.WSERVER_MAINDB_UPDATE_REQUEST_TYPE
        if py_version_info < (3, 0):
            mac = gain.staintf.get_mac().replace(':', '').decode('hex')
        else:
            mac = bytes.fromhex((gain.staintf.get_mac().replace(':', '')))
        maindb_ = gain.sta_maindB
        return cls.__maindb_update_request_struct.pack(msgtype, mac, maindb_)

    @classmethod
    def __create_sidedb_update_request(cls, gain):
        "antenna gain update request"
        # type: (WmediumdGain) -> str
        msgtype = WmediumdCst.WSERVER_GAIN_UPDATE_REQUEST_TYPE
        if py_version_info < (3, 0):
            ...
            mac = bytes.fromhex((gain.staintf.get_mac().replace(':', '')))
        sidedb_ = gain.sta_sidedB
        return cls.__sidedb_update_request_struct.pack(msgtype, mac, gain_)
